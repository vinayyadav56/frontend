                ...
                <div className="card">
                    ...
                    <form className="form-inline trip_search_form" onSubmit={handleFormSubmit} ref={formRef} noValidate>
                        <div className="transport_select_btns">
                            <div className="btn-group-toggle w-auto" data-toggle="buttons">
                        ...
                        <Box sx={{ width: "100%" }}>
                            ...
                            <TabPanel value={activeTab} index={0}>
                                <span className="row">
                                    ...
                                    <span className="form-group col-sm-6 col-md-6  mb-sm-4 px-2  col-lg-4">
                                        <label htmlFor="#depdate">From Date</label>
                                        <DatePicker
                                            name="dept_date"
                                            selected={() => (new Date())}
                            ...
                            <TabPanel value={activeTab} index={1}>
                                ...
                                <img src={trip} alt="triploc" />
                                    ...
                                    <span className="form-group col-sm-6 col-md-6 mb-sm-4 px-2  col-lg-4">
                                        <label htmlFor="#retdate">To Date</label>
                                        <DatePicker
                                            name="return_date"
                                            selected={() => (new Date())}
